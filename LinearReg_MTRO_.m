% Linear regression plot for MTRO vs the market FTSE 100
...
plot(Rm,Ri);% MTRO return vs market return - plot per working day
hold on
plot(RET(:,1),RET(:,2),'yo'); 
xlabel('R_m(t)')
ylabel('R_{a}(t)')
legend('Optimal regression line','(FTSE,MTRO) returns per working day')
title('Linear regression plot for MTRO vs market')
