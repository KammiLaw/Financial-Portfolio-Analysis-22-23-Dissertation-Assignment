% Linear regression plot for BARC vs the market FTSE 100
...
plot(Rm,Ri);% BARC return vs market return - plot per working day
hold on
plot(RET(:,1),RET(:,2),'go'); 
xlabel('R_m(t)')
ylabel('R_{a}(t)')
legend('Optimal regression line','(FTSE,BARC) returns per working day')
title('Linear regression plot for BARC vs market')
